...
private:
	...
	for (i = 45; i <= 45; ++i) start.set(i, 24);
	...
	keywords.set(L"REVEAL", 27);
	keywords.set(L"RETURN", 28);
	keywords.set(L"if", 29);
	keywords.set(L"STACK", 30);
	keywords.set(L"MAPPING", 32);
	keywords.set(L"IMPORT", 33);
